...
$bannerPlaceholderSvg = "data:image/svg+xml;utf8," . rawurlencode(
    "<svg xmlns='http://www.w3.org/2000/svg' width='1400' height='420' viewBox='0 0 1400 420'>
        ...
        <rect width='1400' height='420' fill='url(%23g)'/>
        <rect x='40' y='40' width='1320' height='340' rx='28' fill='none' stroke='#334155' stroke-width='2'/>
        <text x='700' y='190' text-anchor='middle' fill='#e2e8f0' font-size='36' font-family='Arial, sans-serif' font-weight='700'>
            Contact admin for your product ads here
        </text>
        <text x='700' y='235' text-anchor='middle' fill='#94a3b8' font-size='18' font-family='Arial, sans-serif'>
            ...
            <div class="banner-carousel">
                <div class="carousel-container">
                    <?php if (!empty($banners)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <!-- Placeholder banner if none in DB -->
                        <div class="carousel-slide active">
                            <img src="<?php echo htmlspecialchars($bannerPlaceholderSvg); ?>" alt="Contact admin for ads">
                        </div>
                    <?php endif; ?>
                </div>
