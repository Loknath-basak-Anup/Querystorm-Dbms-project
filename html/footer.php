    ...
    <div class="footer-container">
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo htmlspecialchars($base . '/html/products_page.php'); ?>"><i class="fas fa-chevron-right"></i> Shop Now</a></li>
                    <li><a href="<?php echo htmlspecialchars($base . '/buyer_dashboard/cart.php'); ?>"><i class="fas fa-chevron-right"></i> My Cart</a></li>
                    <li><a href="<?php echo htmlspecialchars($base . '/buyer/profile.php'); ?>"><i class="fas fa-chevron-right"></i> User Profile</a></li>
                    <li><a href="<?php echo htmlspecialchars($base . '/buyer_dashboard/saved_items.php'); ?>"><i class="fas fa-chevron-right"></i> Saved Items</a></li>
                </ul>
            </div>
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo htmlspecialchars($base . '/html/help_center.php'); ?>"><i class="fa-solid fa-circle-question"></i> Help Center</a></li>
                    <li><a href="#"><i class="fas fa-shield-alt"></i> Trust & Safety</a></li>
                    <li><a href="<?php echo htmlspecialchars($base . '/html/shipping.php'); ?>"><i class="fas fa-truck"></i> Shipping Info</a></li>
                    <li><a href="<?php echo htmlspecialchars($base . '/html/returns.php'); ?>"><i class="fas fa-undo"></i> Returns</a></li>
                </ul>
            </div>
            ...
            <div class="footer-section">
                ...
                <div style="margin-top: 1.5rem;">
                    ...
                    <a href="<?php echo htmlspecialchars($base . '/html/developer.php'); ?>" class="footer-team-btn">
        ...
        <div class="footer-bottom">
            ...
            <div class="bottom-links">
                <a href="<?php echo htmlspecialchars($base . '/html/products_page.php'); ?>">Marketplace</a>
                <a href="<?php echo htmlspecialchars($base . '/html/shipping.php'); ?>">Shipping Info</a>
                <a href="<?php echo htmlspecialchars($base . '/html/returns.php'); ?>">Returns & Refunds</a>
                <a href="<?php echo htmlspecialchars($base . '/html/privacy.php'); ?>">Privacy Policy</a>
                <a href="<?php echo htmlspecialchars($base . '/html/terms.php'); ?>">Terms of Service</a>
                <a href="<?php echo htmlspecialchars($base . '/html/cookies.php'); ?>">Cookie Settings</a>
            </div>
        </div>
    </div>
</footer>
...
<script>
    (function() {
        ...
        footerLinks.forEach(link => link.setAttribute('href', '#'));
    })();
