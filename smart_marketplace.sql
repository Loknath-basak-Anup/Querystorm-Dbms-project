...
CREATE TABLE `banners` (
  ...
  `position` varchar(40) NOT NULL DEFAULT 'products_top',
...
(7, 'Uttara, Dhaka, Dhaka, 1230, BD', '2026-01-22 17:47:07');
...
INSERT INTO `carts` (`cart_id`, `buyer_id`, `created_at`) VALUES
(1, 7, '2026-01-22 17:47:07');
...
--
-- Table structure for table `coupon_product_allow`
--

CREATE TABLE `coupon_product_allow` (
...
--
-- Table structure for table `coupon_seller_requests`
--

CREATE TABLE `coupon_seller_requests` (
...
--
-- Table structure for table `order_delivery_steps`
--
...
CREATE TABLE `seller_verification_requests` (
  ...
  `business_document_url` varchar(500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `seller_verification_requests`
--

INSERT INTO `seller_verification_requests` (`request_id`, `seller_id`, `nid`, `date_of_birth`, `business_type`, `business_category`, `tax_id`, `business_license`, `address`, `bank_name`, `account_name`, `account_number`, `routing_number`, `branch_name`, `status`, `created_at`, `id_document_url`, `business_document_url`) VALUES
(0, 8, '1252325423', '1999-06-23', 'individual', 'books', NULL, NULL, 'Uttara, Dhaka, Dhaka, Dhaka, 1230, BD', 'Agrani Bank PLC', 'Romiz', '123456789123', '252', 'Uttara', 'approved', '2026-01-22 17:51:04', 'https://iinspwgtlrguudrxlbhn.supabase.co/storage/v1/object/public/product-images/seller-verification/1769104262_486078d05bf8.jpg', 'https://iinspwgtlrguudrxlbhn.supabase.co/storage/v1/object/public/product-images/seller-verification/1769104263_9a2cf06215d2.png');
...
INSERT INTO `shops` (`shop_id`, `seller_id`, `shop_name`, `shop_description`, `address`, `city`, `country`, `phone`, `email`, `logo_url`, `banner_url`, `verified`, `rating`, `created_at`, `updated_at`) VALUES
(1, 3, 'Demo Shop', 'Main demo seller shop', 'Road 21, Dhaka', 'Dhaka', 'Bangladesh', '01700000000', 'seller@quickmart.test', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&auto=format&fit=crop', 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=1200&auto=format&fit=crop', 1, 4.80, '2026-01-10 05:02:15', '2026-01-10 05:02:15');
...
INSERT INTO `users` (`user_id`, `role_id`, `full_name`, `email`, `phone`, `profile_image_url`, `password`, `status`, `created_at`) VALUES
(1, 1, 'Admin', 'admin@quickmart.test', '01000000000', NULL, 'admin123', 'active', '2026-01-10 05:02:15'),
(3, 3, 'Demo Seller', 'seller@quickmart.test', '01700000000', NULL, 'seller123', 'active', '2026-01-10 05:02:15'),
(7, 2, 'Shahriar Ahmed', 'shahriarahmedriaz04@gmail.com', '+8801997741819', 'https://iinspwgtlrguudrxlbhn.supabase.co/storage/v1/object/public/product-images/profile-images/1769104080_12ca636fe417.png', '*RIAZ2026*', 'active', '2026-01-22 17:47:07'),
(8, 3, 'Romiz Sheikh', 'romiz2026@gmail.com', '01823232323', 'https://iinspwgtlrguudrxlbhn.supabase.co/storage/v1/object/public/product-images/profile-images/1769104403_9ca6bbf4480e.png', '*ROMIZ2026*', 'active', '2026-01-22 17:51:02');
...
ALTER TABLE `cart_coupons`
  ADD PRIMARY KEY (`cart_id`),
  ADD KEY `idx_cart_coupon` (`coupon_purchase_id`);
...
--
-- Indexes for table `coupon_product_allow`
--
...
ALTER TABLE `coupon_purchases`
  ...
  ADD KEY `idx_coupon_buyer` (`buyer_id`),
  ADD KEY `idx_coupon_purchase` (`coupon_id`);

--
-- Indexes for table `coupon_seller_requests`
--
ALTER TABLE `coupon_seller_requests`
  ADD PRIMARY KEY (`request_id`),
  ADD UNIQUE KEY `uq_coupon_seller` (`coupon_id`,`seller_id`),
...
--
ALTER TABLE `order_delivery_steps`
  ADD PRIMARY KEY (`order_id`,`step`);
...
ALTER TABLE `shops`
  ...
  ADD UNIQUE KEY `uq_shops_seller` (`seller_id`),
  ADD KEY `idx_shops_verified` (`verified`);
...
--
ALTER TABLE `shops`
  ADD CONSTRAINT `fk_shops_seller` FOREIGN KEY (`seller_id`) REFERENCES `seller_profiles` (`seller_id`) ON DELETE CASCADE;
