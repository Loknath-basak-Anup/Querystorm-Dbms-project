...
--
DROP DATABASE IF EXISTS `smart_marketplace`;
CREATE DATABASE IF NOT EXISTS `smart_marketplace` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `smart_marketplace`;
