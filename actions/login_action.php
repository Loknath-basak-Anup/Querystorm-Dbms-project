...
if ($email === "" || $password === "") {
  header("Location: /QuickMart/html/login.php?err=1");
  exit;
}
...
if ($u["role_name"] === "seller") {
  header("Location: /QuickMart/seller_dashboard/seller_dashboard.php");
} elseif ($u["role_name"] === "buyer") {
  header("Location: /QuickMart/buyer_dashboard/buyer_dashboard.php");
} else {
  header("Location: /QuickMart/index.php");
}
exit;
