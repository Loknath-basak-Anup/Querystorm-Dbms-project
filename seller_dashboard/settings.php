...
<body class="dark-mode">
    ...
    <main class="main-content">
        ...
        <div class="page-content">
            <div class="products-grid" style="grid-template-columns:repeat(auto-fill,minmax(320px,1fr))">
                <div class="product-card"><div class="product-info"><h3 class="product-title">Shop Profile</h3><p class="product-creator">Update your shop name, contact and description</p><div class="product-footer"><button class="btn-add-cart" onclick="openModal('profile')"><i class="fas fa-store"></i><span>Edit Shop Profile</span></button></div></div></div>
                <div class="product-card"><div class="product-info"><h3 class="product-title">Security</h3><p class="product-creator">Change password and secure your account</p><div class="product-footer"><button class="btn-add-cart" onclick="openModal('security')"><i class="fas fa-shield-alt"></i><span>Manage Security</span></button></div></div></div>
                <div class="product-card"><div class="product-info"><h3 class="product-title">Notifications</h3><p class="product-creator">Order, payout & marketing alerts</p><div class="product-footer"><button class="btn-add-cart" onclick="openModal('notifications')"><i class="fas fa-bell"></i><span>Configure</span></button></div></div></div>
                <div class="product-card"><div class="product-info"><h3 class="product-title">Payout Preferences</h3><p class="product-creator">Manage wallet and payout details</p><div class="product-footer"><button class="btn-add-cart" onclick="openModal('payouts')"><i class="fas fa-wallet"></i><span>Manage</span></button></div></div></div>
            </div>
            <div class="modal-overlay" id="settingsModal">
                <div class="modal-box">
                    <h3 id="modalTitle">Update Setting</h3>
                    <label id="modalLabel">Field</label>
                    <input id="modalInput" />
    ...
    <script>
        ...
        function openModal(type){
            ...
            if(type === 'profile'){
                title.textContent = 'Edit Shop Profile';
                ...
                title.textContent = 'Payout Details';
                label.textContent = 'Payout Account';
            }
        }
        function closeModal(){
            const modal = document.getElementById('settingsModal');
