...
<body class="bg-gray-50 text-gray-900 dark:bg-darkBg dark:text-white transition-colors duration-300 overflow-x-hidden">
    ...
    <nav class="fixed w-full z-50 backdrop-blur-md border-b border-gray-300 dark:border-white/10 bg-white/90 dark:bg-black/50 shadow-sm">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex gap-8 text-sm font-medium text-gray-700 dark:text-gray-300">
                <a href="html/products_page.php" class="hover:text-primary hover:scale-110 transition-all duration-300 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full" data-i18n="nav_solutions">Shop</a>
                <a href="#" class="hover:text-primary hover:scale-110 transition-all duration-300 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full" data-i18n="nav_resources">Categories</a>
                
                <!-- Deals Dropdown -->
                <div class="relative group">
                    <a href="#" class="hover:text-primary hover:scale-110 transition-all duration-300 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full flex items-center gap-1" data-i18n="nav_download">
                        Deals <i class="fa-solid fa-chevron-down text-xs group-hover:rotate-180 transition-transform duration-300"></i>
                    </a>
                    
                    <!-- Dropdown Menu -->
                    <div class="absolute top-full left-0 mt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 -translate-y-2">
                        <div class="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-2xl border-2 border-gray-200 dark:border-white/10 overflow-hidden backdrop-blur-xl">
                            <a href="#" class="block px-5 py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-300 group/item">
                                <div class="flex items-center gap-3">
                                    <i class="fa-solid fa-fire text-orange-500 group-hover/item:scale-125 transition-transform duration-300"></i>
                                    <div>
                                        <p class="font-bold text-sm text-gray-800 dark:text-white">Hot Deals</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Up to 70% off</p>
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="block px-5 py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-300 group/item">
                                <div class="flex items-center gap-3">
                                    <i class="fa-solid fa-bolt text-yellow-500 group-hover/item:scale-125 transition-transform duration-300"></i>
                                    <div>
                                        <p class="font-bold text-sm text-gray-800 dark:text-white">Flash Sale</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Limited time only</p>
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="block px-5 py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-300 group/item">
                                <div class="flex items-center gap-3">
                                    <i class="fa-solid fa-tags text-green-500 group-hover/item:scale-125 transition-transform duration-300"></i>
                                    <div>
                                        <p class="font-bold text-sm text-gray-800 dark:text-white">Coupons</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Save more money</p>
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="block px-5 py-3 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-300 group/item">
                                <div class="flex items-center gap-3">
                                    <i class="fa-solid fa-gift text-pink-500 group-hover/item:scale-125 transition-transform duration-300"></i>
                                    <div>
                                        <p class="font-bold text-sm text-gray-800 dark:text-white">Special Offers</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Exclusive bundles</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <a href="#" class="hover:text-primary hover:scale-110 transition-all duration-300 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all after:duration-300 hover:after:w-full" data-i18n="nav_pricing">Sellers</a>
            </div>
    ...
    <!-- Categories Gallery -->
    <section class="py-20 from-purple-50 via-pink-50 to-blue-50" style="background: transparent;">
        <div class="container mx-auto px-6">
