...
$userRow = db_fetch(
    "SELECT u.full_name, u.email, u.phone, u.status, COALESCE(bp.address, '') AS address
     FROM users u
...
<body class="dark-mode">
    ...
    <div class="container">
        ...
        <div class="profile-header">
            <img src="https://static.vecteezy.com/system/resources/previews/019/879/186/non_2x/user-icon-on-transparent-background-free-png.png" alt="Profile" class="profile-avatar">
