...
<body>
        ...
        <div class="signup-card">
            <form id="buyerSignupForm" action="../actions/register_action.php" method="POST" novalidate>
                ...
                <div class="step-actions">
                    ...
                    <button type="submit" class="btn-primary" id="submitStepBtn" style="display:none;">
    ...
    <script>
        ...
        document.getElementById('buyerSignupForm').addEventListener('submit', function(e) {
            const currentStep = parseInt(document.querySelector('.form-step.active')?.getAttribute('data-step') || '0', 10);
        ...
        function showStep(stepIndex) {
            ...
            nextStepBtn.style.display = stepIndex === steps.length - 1 ? 'none' : 'inline-flex';
            submitStepBtn.style.display = stepIndex === steps.length - 1 ? 'inline-flex' : 'none';
        }
