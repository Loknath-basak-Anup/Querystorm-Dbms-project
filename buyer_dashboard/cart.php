...
<body class="dark-mode">
    ...
    <script>
        ...
        function renderCartItems() {
            ...
            fetch('cart_action.php?action=get', {
                ...
                .then(data => {
                    ...
                    updateOrderSummary(subtotal, delivery);
        ...
        function updateOrderSummary(subtotal, delivery) {
    ...
    <script>
        ...
        async function handlePayment() {
            ...
            try {
                ...
                // Clear cart on server after "payment"
                const clearForm = new URLSearchParams();
                clearForm.append('action', 'clear');

                const clearRes = await fetch('cart_action.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded',
                        'X-Requested-With': 'XMLHttpRequest'
                ...
                if (!clearData || !clearData.success) {
                    console.warn('Cart clear failed after payment:', clearData && clearData.message);
                }
                ...
                showNotification(`Payment successful with ${label}! Order placed for ${total.toLocaleString()} BDT.`, 'success');

                // Optional redirect to order history after short delay
                setTimeout(() => {
