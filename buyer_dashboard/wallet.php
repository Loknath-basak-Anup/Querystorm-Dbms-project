...
// Handle Add Money request (simple server-side insert)
    ...
    if ($action === 'add_money') {
        ...
        if ($amount > 0) {
            ...
            try {
                ...
                error_log('Add money failed: ' . $e->getMessage());
        ...
        // Fetch current balance to validate withdrawal
...
try {
    ...
    // If wallet_transactions table doesn't exist, initialize with defaults
...
<head>
    ...
    <style>
        ...
        @media (max-width: 1024px) {
            .wallet-container { grid-template-columns: 1fr !important; }
        }
    </style>
</head>
    ...
    <main class="main-content">
        ...
        <div class="page-content" style="padding: 1.5rem;">
            <div style="margin-bottom: 1.5rem;">
                <a href="./buyer_dashboard.php" style="color: #3b82f6; text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; gap: 0.5rem;">
